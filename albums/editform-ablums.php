...
<button type="button" class="btn btn-link" data-bs-toggle="modal" data-bs-target="#editAlbumModal<?php echo $album['album_id']; ?>">
                ...
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  ...
                  <div class="modal-body">
                          <form method="post" action="">
                                    ...
                                    <?php
                                      $recordsList = selectAlbumsforInput();
                                      $selectedAlbum = $album['artist_name'];
                                    ...
                                    <div class="mb-3">
                                      <label for="gid<?php echo $album['album_id']; ?>" class="form-label">Genre:</label>
      
                                      <?php
                                      $genresList = selectGenresforInput();
                                      $selectedGenre = $album['genre_name'];
                                    ...
                                    <div class="mb-3">
                                      <label for="alYear<?php echo $album['album_id']; ?>" class="form-label">Album Year:</label>
                                      <input type="text" class="form-control" id="alYear<?php echo $album['album_id']; ?>" name="alYear" value="<?php echo $album['album_year']; ?>">
                                    </div>
