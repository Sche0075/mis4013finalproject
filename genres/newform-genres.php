...
<div style="height:16px;width:16px;margin-right:70px;margin-top:30px;">
  <button type="button" class="btn btn-link" data-bs-toggle="modal" data-bs-target="#newGenreModal">
   ...
   <div class="modal-dialog">
        <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="newGenreModalLabel">New Song</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  ...
                  <div class="modal-body">
                          <form method="post" action="">
                                    ...
                                    <div class="mb-3">
                                      <label for="gDescription" class="form-label">Genre Description</label>
                                      <input type="text" class="form-control" id="gDescription" name="gDescription">
                                    </div>                                  
